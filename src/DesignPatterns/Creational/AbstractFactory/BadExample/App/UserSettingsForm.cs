...
using Project.src.DesignPatterns.Creational.AbstractFactory.BadExample.Mac;
using Project.src.DesignPatterns.Creational.AbstractFactory.BadExample.Windows;

namespace Project.src.DesignPatterns.Creational.AbstractFactory.BadExample.App
{
